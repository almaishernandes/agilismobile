...
const s = StyleSheet.create({
    ...
    fieldLabel: { color: '#89962F', fontSize: 11, marginTop: 0, marginBottom: 2 },
    field: { backgroundColor: '#0f172a', color: '#fff', borderRadius: 8, borderWidth: 1, borderColor: '#334155', padding: 10, fontSize: 16, fontWeight: '700', marginBottom: 8 },
    fieldReadonly: { paddingVertical: 10 },
    fieldWaiting: { color: '#475569', fontWeight: '400', fontStyle: 'italic' },
    input: { backgroundColor: '#0f172a', color: '#fff', borderRadius: 8, borderWidth: 1, borderColor: '#334155', padding: 10, fontSize: 16, fontWeight: '700', marginBottom: 8 },
    installHint: { color: '#89962F', fontSize: 12, marginTop: 2 },
    payTypeBadge: { backgroundColor: '#004d40', borderRadius: 8, padding: 8, marginTop: 2, alignSelf: 'flex-start' },
    payTypeText: { color: '#CCFF00', fontSize: 12 },
    saveBtn: { backgroundColor: '#CCFF00', borderRadius: 12, padding: 18, alignItems: 'center', marginTop: 8 },
